...
@section('title', 'Edit Kupon - Admin MusicStore Luxe')
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="number" step="any" name="max_discount" id="max_discount" value="{{ old('max_discount', $coupon->max_discount) }}"
                        class="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-slate-950 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:bg-white transition text-xs font-semibold" />
                </div>
            </div>
