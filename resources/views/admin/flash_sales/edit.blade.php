...
@section('title', 'Edit Flash Sale - Admin DjudasMS')
...
<div class="space-y-6" x-data="flashSaleForm()">
    ...
    <div class="border-b border-walnut-800/10 pb-6 flex items-center justify-between">
        <div>
            ...
            <h1 class="text-3xl font-black uppercase tracking-tight text-walnut-950 mt-2">Edit Flash Sale</h1>
        </div>
            ...
            init() {
                @foreach($flashSale->items as $item)
                    this.items.push({
                        ...
                        maxStock: {{ $item->product->stock + $item->stock }},
