                        ...
                        <tr class="border-b border-walnut-800/10 last:border-0 hover:bg-cream-100/50">
                            ...
                            <td class="px-6 py-6 text-center">
                                ...
                                @elseif($order->status === 'shipped')
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-walnut-50 text-walnut-800 border border-walnut-200 uppercase">Shipped</span>
                                @elseif($order->status === 'completed')
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-walnut-950 text-white border border-walnut-950 uppercase">Completed</span>
                                @else
                            ...
                            <!-- Payment Status -->
                            <td class="px-6 py-6 text-center">
                                <span class="px-2.5 py-0.5 rounded-full text-xs font-bold {{ $order->payment && $order->payment->status === 'paid' ? 'bg-walnut-950 text-white' : 'bg-gold-50 text-gold-700 border border-gold-200' }} uppercase">
