...
<head>
    ...
    <title>Pesanan Selesai DjudasMS</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="icon">🎉</div>
            <div class="greeting">Terima Kasih, {{ $order->user->name ?? 'Pelanggan' }}!</div>
            <div class="message">
                Anda telah mengonfirmasi bahwa pesanan <strong>#{{ $order->order_code }}</strong> telah diterima dengan baik. Transaksi ini sekarang ditandai sebagai Selesai.
            </div>
            
            <div class="message">
                Bantu pelanggan lain dengan memberikan ulasan mengenai pengalaman belanja dan kualitas produk kami.
            </div>

            <div class="btn-container">
                <a href="{{ url('/orders/' . $order->order_code) }}" class="btn">Beri Ulasan Sekarang</a>
            </div>
        </div>
        <div class="footer">
